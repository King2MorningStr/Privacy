...
# (used for native services on Android)
#android.service = myapp.service:ServiceName
...
# (str) Android service to run in the background on app start
...
#    source.exclude_patterns = images/hd/*
#
